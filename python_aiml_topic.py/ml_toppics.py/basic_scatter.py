...
x = np.random.normal(0, 1, 10)  # Generate 100 random values from a normal distribution with mean 0 and standard deviation 1
y = 2 * x + np.random.normal(0, 1, 10)  # Calculate y values as a linear function of x plus some random noise

# Generate two additional sets of random data
z = np.random.normal(1, 1.5, 10)  # Generate 100 random values from a normal distribution with mean 1 and standard deviation 1.5
w = np.random.normal(-1, 0.5, 10)  # Generate 100 random values from a normal distribution with mean -1 and standard deviation 0.5
